module Mini_ledger_core.Tokens._.Deserialize
...
type __Visitor_t = {
  marker:Core.Marker.phantomData_t Mini_ledger_core.Tokens.tokens_t;
  lifetime:Core.Marker.phantomData_t Prims.unit
}

let fIELDS: FStar.Seq.seq Prims.string = Hacspec.Lib.unsize ["e8s"]