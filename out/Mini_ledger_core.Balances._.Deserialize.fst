module Mini_ledger_core.Balances._.Deserialize
...
type __Visitor_t = {
  marker:Core.Marker.phantomData_t (Mini_ledger_core.Balances.balances_t accountid s);
  lifetime:Core.Marker.phantomData_t Prims.unit
}

let fIELDS: FStar.Seq.seq Prims.string = Hacspec.Lib.unsize ["store"; "icpt_pool"; "token_pool"]